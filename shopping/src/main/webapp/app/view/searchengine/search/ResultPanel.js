Ext
		.define(
				'Shopping.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Shopping.view.searchengine.search.SearchEngineMainPanelController','Shopping.view.searchengine.search.PanelHeaderField' ,'Shopping.view.searchengine.search.ReportGridView','Shopping.view.searchengine.search.ReportChartView','Shopping.view.searchengine.search.documentView','Shopping.view.searchengine.search.DouMeanView','Shopping.view.googlemaps.map.MapPanel'],
