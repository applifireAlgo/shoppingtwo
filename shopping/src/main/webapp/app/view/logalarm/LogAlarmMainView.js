 ...
 * 
 */
Ext.define('Shopping.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Shopping.view.logalarm.LogAlarmMainViewController',
			'Shopping.view.logalarm.tree.LogAlarmTreePanel',
			'Shopping.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
