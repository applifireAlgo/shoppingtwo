 ...
 * 
 */
Ext.define('Shopping.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Shopping.view.logalarm.mainscreen.AddLogAlarmController',
			'Shopping.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Shopping.view.logalarm.mainscreen.AppAlarmPanel',
