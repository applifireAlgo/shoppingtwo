Ext.define('Shopping.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Shopping.view.usermanagement.admin.UserPasswordReset',
	            'Shopping.view.usermanagement.admin.AddUserDetails',
	            'Shopping.view.usermanagement.admin.ViewUser'],
