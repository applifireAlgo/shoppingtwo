Ext.define('Shopping.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Shopping.view.usermanagement.admin.AddUserDetailsViewModel', 'Shopping.model.AddUserDataModel' ],
