Ext.define('Shopping.view.mainleftmenutree.TopPanel.TopPanelController', {
	...
	onCloudClick : function()
	{
		var component = Ext.create(
				"Shopping.view.clouddrive.CloudDrive", {
					closable : true,
					title : "Cloud Drive"
					//refId : "-1"
				});
	...
	{
		var component = Ext.create(
				"Shopping.view.usermanagement.enduser.UserProfile", {
					closable : true,
					title : "My Profile"
				});
	...
	{
		var component = Ext.create(
				"Shopping.view.usermanagement.enduser.ChangePwd", {
					closable : true,
