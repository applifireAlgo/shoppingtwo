 ...
 */
Ext.define('Shopping.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Shopping.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Shopping.view.fw.component.DateTimePicker(o);
    },
