...
Ext
		.define(
				'Shopping.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Shopping.view.logger.tabs.details.DetailsTab',
							'Shopping.view.logger.tabs.fileconnector.FileConnectorTab',
							'Shopping.view.logger.tabs.dbconnector.DBConnectorTab',
							'Shopping.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Shopping.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Shopping.view.logger.LogConfigurationTabPanelController',
