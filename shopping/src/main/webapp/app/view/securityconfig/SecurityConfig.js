 ...
 * 
 */
Ext.define('Shopping.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Shopping.view.securityconfig.SecurityConfigController',
			'Shopping.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
