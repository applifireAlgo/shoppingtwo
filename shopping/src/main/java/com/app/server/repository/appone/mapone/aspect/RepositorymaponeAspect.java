package com.app.server.repository.appone.mapone.aspect;
...
@Aspect
@Component
public class RepositorymaponeAspect extends RepositoryAspect {
    ...
    @Pointcut("execution(* com.app.server.repository.appone.mapone..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.appone.mapone..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.appone.mapone..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.appone.mapone..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.appone.mapone..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.appone.mapone..*(..))")
