package com.app.server.businessservice.appone.mapone.aspect;
...
@Aspect
@Component
public class BusinessServicemaponeAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* com.app.server.businessservice.appone.mapone..*(..))")
