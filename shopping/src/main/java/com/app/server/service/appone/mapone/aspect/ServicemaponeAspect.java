package com.app.server.service.appone.mapone.aspect;
...
@Aspect
@Component
public class ServicemaponeAspect extends ServiceAspect {
    ...
    @Pointcut("execution(* com.app.server.service.appone.mapone..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* com.app.server.service.appone.mapone..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* com.app.server.service.appone.mapone..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* com.app.server.service.appone.mapone..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* com.app.server.service.appone.mapone..get*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* com.app.server.service.appone.mapone..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
