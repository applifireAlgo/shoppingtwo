...
public class UserTestCase extends EntityTestCriteria {
    ...
    private User createUser(Boolean isSave) throws SpartanPersistenceException, SpartanConstraintViolationException {
        ...
        useraccessdomain.setDomainDescription("kTTEuuyk5P18iwnzwkXMo4cJGxLwuIHDJrjIN7fkhVef7KtN4u");
        useraccessdomain.setDomainName("qsu4IfotC6v7lhakHWgxfIJD3vX119MTSCC9YcStGAEYxoDEik");
        useraccessdomain.setDomainHelp("I8egb1hNw4rmsWHhgVRytfVBleZ8XuriCRmw3zHftY1CI1cEQG");
        useraccessdomain.setDomainIcon("fQEjVamkOPK33i2lce5TheuCbMBM2nPPna5v5vZvrOyDK2dNuV");
        ...
        useraccesslevel.setLevelDescription("W18XZ06ehx4VtWSKilIAO2O4X8Fp6cQWzpHU6fCybWxqYY7n9J");
        useraccesslevel.setUserAccessLevel(valueGenerator.getRandomInteger(99999, 0));
        useraccesslevel.setLevelName("AEWUcnHgAlNrg9FZBTW2jvnr7c2utnGoZW2kcdrJZR7rrh4WDJ");
        useraccesslevel.setLevelIcon("aUvd1An4xGci0bESUVme7bgCJ9VEx5K73FYTLnTTbtBkVKnBJM");
        useraccesslevel.setLevelHelp("lXlA5wr8F8fqhxjaFkXW9CEV6xHwm1Hd51OZlAIGcUOaWpr708");
        ...
        User user = new User();
        user.setUserAccessCode(30602);
        user.setSessionTimeout(1724);
        user.setMultiFactorAuthEnabled(1);
        user.setUserAccessDomainId((java.lang.String) UserAccessDomainTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setLastPasswordChangeDate(new java.sql.Timestamp(1459432495089l));
        user.setGenTempOneTimePassword(1);
        user.setAllowMultipleLogin(1);
        user.setPasswordExpiryDate(new java.sql.Timestamp(1459432495090l));
        user.setUserAccessLevelId((java.lang.String) UserAccessLevelTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setChangePasswordNextLogin(1);
        user.setPasswordAlgo("MJp5QdPHV5kNRJliMx0BFarQwJOyKrlphlbMpqaW7RTEIGkk6O");
        user.setIsLocked(1);
        user.setIsDeleted(1);
        java.util.List<PassRecovery> listOfPassRecovery = new java.util.ArrayList<PassRecovery>();
        PassRecovery passrecovery = new PassRecovery();
        Question question = new Question();
        question.setQuestionDetails("pXuWVTT3YH");
        question.setQuestion("SP2tkcmpf5sVET60RXJqKxFMiD8bxV1C6ih5vN8W05vlIxRMNy");
        question.setLevelid(4);
        question.setQuestionIcon("u0ma2DQpF2ldIufPtocogtrjMrPqFuiuauTkNprVefV45WVUCg");
        ...
        passrecovery.setAnswer("FYn3ekuoeAh6n9blpntCzSVLAWv0r3W9VfxwjEeTRHdBa8NoI4");
        listOfPassRecovery.add(passrecovery);
        user.addAllPassRecovery(listOfPassRecovery);
        UserData userdata = new UserData();
        userdata.setOneTimePassword("fXMLckYt1ugTZpIAdPN9P0ktA0g7uben");
        userdata.setLast5Passwords("iuC4S4tPjnZexltao5hQXwfQ74GnKUxiNPqxXKqaAcm2xQWbnM");
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1459432495677l));
        userdata.setPassword("1PttcYdTW3K6ARt0ivBcZ4wlRAvqHbj1AsvLuplrBgM3MgQ9YP");
        userdata.setOneTimePassword("AjUMYvU420bA3AJwDH0C8hufQmd5tyNG");
        userdata.setLast5Passwords("CthImZKv1q0qqXd74D75f6GLUIdoFAiBesHnVdlNFSCVIIjCWS");
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1459432495709l));
        userdata.setPassword("cFMBrpo7g9oWMEA9MvqZl8fblBsBRaOCUuA4qtxRgMr1Wx3NsI");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 1, "userAccessCode", 93604));
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 8, "passwordAlgo", "ZMlrxdxTZ4nMbps2iBsW3AWtCnab28CFpJS0olBCw4Kf5jbgORLAM9CuBcAjmkMa5"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 9, "sessionTimeout", 5379));
